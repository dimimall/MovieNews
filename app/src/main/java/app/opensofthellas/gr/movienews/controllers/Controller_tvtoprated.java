...
public class Controller_tvtoprated {

    static final String BASE_URL = "https://api.themoviedb.org/3/";
    MainActivity mainActivity;
    Context context;
    private static Controller_tvtoprated repository;

    private MovieApi api;

    private Controller_tvtoprated(MovieApi api) {
        this.api = api;
    }

    public static Controller_tvtoprated getInstance() {
        if (repository == null) {
            ...
            repository = new Controller_tvtoprated(retrofit.create(MovieApi.class));
        }

        return repository;
    }

    public void getTvTopRated(final OnGetTvCallback callback) {
        api.getTvTopRated("8dc2e4947c8c911cbfbe7fdfb08c16c3", "en-US", 1)
