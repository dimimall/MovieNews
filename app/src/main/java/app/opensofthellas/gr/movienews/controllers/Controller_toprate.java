...
public class Controller_toprate {

    static final String BASE_URL = "https://api.themoviedb.org/3/";
    MainActivity mainActivity;
    Context context;
    private static Controller_toprate repository;

    private MovieApi api;

    private Controller_toprate(MovieApi api) {
        this.api = api;
    }

    public static Controller_toprate getInstance() {
        if (repository == null) {
            ...
            repository = new Controller_toprate(retrofit.create(MovieApi.class));
        }
    ...
    public void getMovies(final OnGetMoviesCallback callback) {
        api.getTopRatedMovies("8dc2e4947c8c911cbfbe7fdfb08c16c3", "en-US", 1)
