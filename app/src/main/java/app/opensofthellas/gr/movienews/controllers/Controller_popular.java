...
public class Controller_popular {

    static final String BASE_URL = "https://api.themoviedb.org/3/";
    MainActivity mainActivity;
    Context context;
    private static Controller_popular repository;

    private MovieApi api;

    private Controller_popular(MovieApi api) {
        this.api = api;
    }

    public static Controller_popular getInstance() {
        if (repository == null) {
            ...
            repository = new Controller_popular(retrofit.create(MovieApi.class));
        }
    ...
    public void getMovies(final OnGetMoviesCallback callback) {
        api.getPopularMovies("8dc2e4947c8c911cbfbe7fdfb08c16c3", "en-US", 1)
